...
# ===============================================================
# PART 4: MULTIPLE EC2 INSTANCE COUNT
# ===============================================================
echo ""
echo "==============================================="
echo "       PILIH JUMLAH EC2 INSTANCE YANG DIBUAT     "
echo "==============================================="
echo "1. 1 Instance (Default)"
echo "2. 2 Instances"
echo "3. 3 Instances"
echo "4. 4 Instances"
echo "5. 5 Instances"
echo "0. Custom"
echo "-----------------------------------------------"
read -p "Masukkan pilihan jumlah instance [1-5]: " count_choice
echo ""
case $count_choice in
    ...
    4) vm_count=4 ;;
    5) vm_count=5 ;;
    0) read -p "Masukkan jumlah instance custom: " vm_count ;;
    *) echo "Pilihan tidak valid. Default ke 1 instance."; vm_count=1 ;;
esac
...
sed -i "s/^\(vm_count\s*=\s*\).*/\1$vm_count/" terraform.tfvars
